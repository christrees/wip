# WIP Daily - Wednesday 2026-06-03

[wip.christrees.com](https://wip.christrees.com) | [wip.2cld.net](https://wip.2cld.net) (private)

## Today
**Top 3 Priorities for Tuesday, Jun 2:**
1. `cat9-wip` → check in (07:30)
2. `cat9-treesaes` → travel cf-wf (08:00)
3. `cat9-treesaes` → renovation work (10:00)

**Schedule:**

| Time | Code | What |
|------|------|------|
| 07:30 | `cat9-wip` | check in |
| 08:00 | `cat9-treesaes` | travel cf-wf |
| 10:00 | `cat9-treesaes` | renovation work |
 ...
 **@person:**
 - @person:stacy - Send gutter board repair photos when complete (event-dependent: Wed Jun 3 DoD)
...
---
*Auto-generated by Wip morning-update. Last push: 2026-06-03 08:37*
