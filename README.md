# WIP Daily - Sunday 2026-06-28

[wip.christrees.com](https://wip.christrees.com) | [wip.2cld.net](https://wip.2cld.net) (private)

## Today
**Top 3 Priorities for Sunday, Jun 28:**
1. `cat9-wip` → daily cron report (07:00)
2. `cat9-hwpc` → Mobile field access: offline route data + service logging for techs (08:00)
3. `cat9-hwpc` → Workspace consolidation: reduce 6 accounts to 2 (save $135/yr) (13:00)
...
| 08:00 | `cat9-hwpc` | Mobile field access: offline route data + service logging for techs |
| 13:00 | `cat9-hwpc` | Workspace consolidation: reduce 6 accounts to 2 (save $135/yr) |
| 15:00 | `cat9-hwpc` | CandyBot: automated phone attendant for HWPC reception |
...
---
*Auto-generated by Wip morning-update. Last push: 2026-06-28 07:57*
