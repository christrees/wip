# WIP Daily - Monday 2026-07-27

[wip.christrees.com](https://wip.christrees.com) | [wip.2cld.net](https://wip.2cld.net) (private)

## Today
**Top 3 Priorities for Monday, Jul 27:**
1. `cat9-wip` → daily cron report (08:00)
2. `cat9-wip` → daily standup (08:30)
3. `cat9-wip` → weekly review process + horizon labels + standup revision (09:00)

**Schedule:**

| Time | Code | What |
|------|------|------|
| 07:00 | `chris` | setup braindead browse |
| 08:00 | `cat9-wip` | daily cron report |
| 08:30 | `cat9-wip` | daily standup |
| 09:00 | `cat9-wip` | weekly review process + horizon labels + standup revision |
| 10:00 | `cat9-wip` | weekly review (test run) |
| 11:00 | `chris` | food bd S2E4 IT Crowd |
| 16:00 | `cat-wip` ❓ | dev |
| 19:00 | `chris` | food chicken, sp, onion, carrot, spinage |

**❓ Unknown codes (need routing or are typos):**
- `cat-wip` "cat-wip dev" — known code? typo? new project?
- `cat9-ops-wf` "cat9-ops-wf Cloudflare access: gitea.klopfenstein.org" — known code? typo? new project?
...
---
*Auto-generated by Wip morning-update. Last push: 2026-07-27 20:05*
