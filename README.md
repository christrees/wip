...
| Time | Code | What |
|------|------|------|
| all-day | `andi` | Wis Fireworks |
| 06:00 | `cat9-wip` | daily cron report |
| 06:30 | `cat9-wip` | daily standup |
| 07:00 | `cat9-wip` | LLC: IA 1065 state filing (due Sep 30) |
| 13:00 | `cat9-hwpc` | Development Sandbox - CandyBot |
| 16:00 | `cat9-hwpc` | SLA: confirm hwpc-rp always-up + backup + recovery path |
| 18:00 | `chris` | food, trip prep |
...
|------|-------|---------|--------|-----------|
| cf | 3/3 UP | ✅ healthy (4 conns) | ✅ 20260813-0200 OK | 2026-08-13 |
| sl | 1/1 UP | ✅ down (0 conns) | ✅ receiving | 2026-08-13 |
| wf | 1/1 UP | ✅ healthy (CF) | ✅ receiving | 2026-08-13 |
...
---
*Auto-generated by Wip morning-update. Last push: 2026-08-13 10:57*
